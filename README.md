# Лабораторные работы группы 3826Б1ПР3
...
2. Перейдите в созданный репозиторий и скопируйте ссылку, скрытую за кнопкой **Code**. Она должна иметь вид **`https://github.com/<Имя_вашего_аккаунта>/3826B1PR3-2_1.git`**.
...
11. Если ваша работа готова к проверке, то необходимо создать **`pull request`** из вашего репозитория в общий. В названии укажите ваши ФИО и номер лабораторной в виде ФИО Лабораторная № (например, Ивлев А.Д. Лабораторная №1.2). Если вы правильно назвали pull request, то рядом с названием появится метка (например, lab1).
