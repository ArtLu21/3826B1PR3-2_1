...
2. Перейдите в созданный репозиторий и скопируйте ссылку, скрытую за кнопкой **Code**. Она должна иметь вид **`https://github.com/<Имя_вашего_аккаунта>/3826B1PR3-2.git`**.
